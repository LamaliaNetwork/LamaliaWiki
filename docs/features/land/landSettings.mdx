...
<TH>เมื่อคุณเลือกแลนด์สักที่นึง คุณจะถูกนำไปยังหน้า GUI ดังต่อไปนี้:</TH>
...
<EN>You can set flags for each role and prioritize them accordingly.</EN>
<TH>
...
<EN>
  ...
  **Rename**: Allows you to change the name of the role. 3. **Icon**: You can
  ...
  7. **Management Flags**: Toggle options for each role to trust players,
...
<EN>Customize permissions for animals, fire, entities, and more.</EN>
<TH>ปรับแต่ง Flag เกี่ยวกับสัตว์, เปลวไฟ, เอนทิตี, และอื่น ๆ</TH>
:::
...
<EN>Adjust land name, entry messages, and icons.</EN>
<TH>ปรับแต่งชื่อแลนด์, ข้อความที่แสดงเมื่อเข้า, และไอคอนต่าง ๆ</TH>
:::
